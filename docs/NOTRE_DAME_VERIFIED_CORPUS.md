...
```jsonc
{
  ...
  "spire": {
    ...
    "lead_cladding": { "weight_t": 250, "provenance": "measured", "source": "Friends of NDP / Wikipedia (CONFIRMED)",
        "url": "https://www.friendsofnotredamedeparis.org/cathedral/artifacts/spire/" },
    "ornament_per_spire": { "value": "8 faces × ~200 crockets; ~16 pinnacles, 32 gargoyles, 16 bay arcatures, 8 quadrilobes",
        "provenance": "measured", "source": "constructionbtp + culture.gouv (reconstruction à l'identique counts)",
        "url": "https://www.constructionbtp.com/batiment/article/2023/06/12/144676/fleche-notredame-paris-chef-uvre-charpente-chene" },
    "statues": { "value": "16 copper: 12 apostles (4 groups of 3, staggered) + 4 evangelist symbols; St Thomas faces inward, bears VLD's features",
        "apostle_h_m": 3.40, "apostle_kg": 140, "evangelist_h_m": 2.0, "evangelist_kg": 65,
        ...
        "note": "Removed 11 Apr 2019, four days before fire → originals survive." },
    "rooster": { "approx_kg": 30, "provenance": "measured", "source": "EN/FR Wikipedia + culture.gouv",
        "url": "https://en.wikipedia.org/wiki/Spire_of_Notre-Dame_de_Paris",
        "note": "CITED-UNCERTAIN: ~30 kg (most) vs ~10 kg (one ND culture page). Holds 3 relics. New gilded rooster installed 16 Dec 2023." },
